		...
		return (
			<>
				<div className='player-details'>
					<h4 className='text-element flow'>{this.props.title}</h4>
					<h6 className='text-element'> by </h6>
					<h5 className='text-element flow'>{this.props.artist}</h5>
					<h6 className='text-element'> on </h6>
					<h5 className='text-element flow'>{this.props.album}</h5>
				</div>
			</>
		);
	}
